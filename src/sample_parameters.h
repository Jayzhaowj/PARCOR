...
void sample_beta_tilde(arma::mat& beta_nc_samp, arma::vec& y, arma::mat& x, arma::vec& theta_sr, arma::vec& beta_mean, int N, int n_I, arma::vec& St); //
...
void resample_alpha_diff(arma::mat betaenter, arma::vec& theta_sr, arma::vec& beta_mean, arma::mat beta_diff,  arma::vec& xi2, arma::vec& tau2, int d, int N);
